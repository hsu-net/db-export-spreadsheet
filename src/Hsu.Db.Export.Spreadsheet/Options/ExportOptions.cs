...
public record TableOptions
{
    ...
    [DefaultValue(1000)] public int? Chunk { get; set; } = 1000;
    [DefaultValue(true)] public bool? AscOrder { get; set; } = true;
    public List<TableField> Fields { get; set; }
    [DefaultValue("Csv")] public string Output { get; set; } = "Csv";
    ...
    public record TableField
    {
        ...
        [DefaultValue(null)] public string? Property { get; set; }
        [DefaultValue("String")] public string Type { get; set; } = "String";
        [DefaultValue(true)] public bool? Nullable { get; set; } = true;
        [DefaultValue(null)] public string? Format { get; set; }
        [DefaultValue(false)] public bool? Escape { get; set; } = false;
    }
}
